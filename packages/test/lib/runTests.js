...
var tests = [expectAppContext("Factom (fct)"), { name: "testFctAppConfig", run: _testFctAddr2.default }, { name: "testFctECAddr", run: _testFctECAddr2.default }, { name: "testFctAddr", run: _testFctAddr2.default }, { name: "testFctTx", run: _testFctTx2.default }, { name: "testFctEntryCommit", run: _testFctEntryCommit2.default }, { name: "testFctChainCommit", run: _testFctChainCommit2.default }];
