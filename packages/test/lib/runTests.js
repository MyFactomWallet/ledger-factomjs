...
var _testFctEcTx = require("./testFctEcTx.js");
...
var tests = [expectAppContext("Factom (fct)"), { name: "testFctAddr", run: _testFctAddr2.default }, { name: "testFctAddrDisplay", run: _testFctAddrDisplay2.default }, { name: "testFctECAddr", run: _testFctECAddr2.default }, { name: "testFctTx", run: _testFctTx2.default }, { name: "testFctEntryCommit", run: _testFctEntryCommit2.default }, { name: "testFctChainCommit", run: _testFctChainCommit2.default }, { name: "testFctAppConfig", run: _testFctAppConfig2.default }, { name: "testFctAddrPath", run: _testFctAddrPath2.default }, { name: "testFctIdHashSign", run: _testFctIdHashSign2.default }, { name: "testFctIdAddr", run: _testFctIdAddr2.default }, { name: "testFctTxMultiOut", run: _testFctTxMultiOut2.default }, { name: "testFctEcTx", run: _testFctEcTx2.default }, { name: "testFat0Tx", run: _testFat0Tx2.default }, { name: "testFat1Tx", run: _testFat1Tx2.default }];
