      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            numinputs = 1;
            numoutputs = 1;
            fees = Transaction.builder().input(fromAddr, amount * numoutputs).output(toAddr, amount).build().computeRequiredFees(ecRate, { rcdSignatureLength: numoutputs * (33 + 64), numberOfSignatures: numinputs });
            ...
            t = Transaction.builder().input(fromAddr, amount * numoutputs + fees).output(toAddr, amount).build();
